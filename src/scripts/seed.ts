...
async function seed() {
  ...
  console.log(
    `${x4Created ? "✅ Creada" : "⏭️  Ya existía"} — Modalidad X4 (id: ${x4.id})`,
  );
  console.log(
    `${x5Created ? "✅ Creada" : "⏭️  Ya existía"} — Modalidad X5 (id: ${x5.id})`,
  );
  ...
  console.log(
    `${s1x4Created ? "✅ Creada" : "⏭️  Ya existía"} — Temporada 1 X4 (id: ${s1x4.id})`,
  );
  console.log(
    `${s1x5Created ? "✅ Creada" : "⏭️  Ya existía"} — Temporada 1 X5 (id: ${s1x5.id})`,
  );
