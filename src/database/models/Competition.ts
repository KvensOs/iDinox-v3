...
export const COMPETITION_TYPES = ["league", "cup", "friendly", "other"] as const;
...
> {
     ...
     */
    static async getActiveLeague(modalityId: number): Promise<Competition | null> {
    ...
    static async setActiveLeague(competitionId: number): Promise<void> {
        await sequelize.transaction(async (t) => {
            ...
            if (competition.type !== "league") {
                throw new Error("Solo competitions de tipo 'league' pueden ser la liga activa.");
            }
