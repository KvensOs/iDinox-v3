    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt
            .setName("modalidad")
            .setDescription("Modalidad a abrir.")
            .setRequired(true)
    ...
    .addSubcommand((sub) =>
      sub
        ...
        .addStringOption((opt) =>
          opt
            .setName("modalidad")
            .setDescription("Modalidad a cerrar.")
            .setRequired(true)
            .setAutocomplete(true),
        ),
    )
  ...
  async execute(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    try {
        ...
        await interaction.editReply({
          embeds: [
            new EmbedBuilder()
              ...
              .setDescription(
                `El mercado de **${modality.displayName}** ya está ${nuevoEstado ? "abierto" : "cerrado"}.`,
              ),
          ],
        });
        return;
      ...
      const notifEmbed = new EmbedBuilder()
        ...
        .setTitle(
          `Mercado ${nuevoEstado ? "abierto" : "cerrado"} · ${modality.displayName}`,
        )
        .setDescription(
          nuevoEstado
      ...
      const canales = [
        ...new Set([
          settings.canal_mercado_fichajes,
      ...
      await interaction.editReply({
        embeds: [
          new EmbedBuilder()
            ...
            .setDescription(
              "No se pudo actualizar el estado del mercado. El equipo técnico fue notificado.",
            ),
        ],
      });
    }
